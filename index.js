  ...
  function initialize() {
    ...
    var myLatlng = new google.maps.LatLng(37.7886249,-122.3991397);
    var myOptions = {
      zoom: 15,
      center: myLatlng,
    ...
    places.search(search, function(results, status) {
      if (status == google.maps.places.PlacesServiceStatus.OK) {
        for (var i = 0; i < results.length; i++) {
            if (i<9){
             var icon = 'http://google-maps-icons.googlecode.com/files/darkblue0' + (i+1) + '.png';
             }
            else{
            var icon = 'http://google-maps-icons.googlecode.com/files/darkblue' + (i+1) + '.png';
            }
  ...
  function addResult(result, i) {
    ...
    if (i<9){
  icon.src = 'http://google-maps-icons.googlecode.com/files/darkblue0' + (i+1) + '.png';
             }
            else{
  icon.src = 'http://google-maps-icons.googlecode.com/files/darkblue' + (i+1) + '.png';
            }                                   
